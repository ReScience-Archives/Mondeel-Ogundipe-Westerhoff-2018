...
\fancyfoot[R]{\sffamily May 13 2015 $\vert$
                        Volume \textbf{4} $\vert$
                        Issue \textbf{1}}
\pagestyle{fancy}
\makeatletter
...
\marginpar{
  ...
  {\bfseries Received}  Oct 26, 2017\\
  {\bfseries Accepted}  Mar 25, 2018\\
  {\bfseries Published} May 13, 2018\\
  ...
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Mondeel-Ogundipe-Westerhoff-2018/article}{\faGithubAlt~Article repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Mondeel-Ogundipe-Westerhoff-2018/code}{\faGithubAlt~Code repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Mondeel-Ogundipe-Westerhoff-2018/data}{\faGithubAlt~Data repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Mondeel-Ogundipe-Westerhoff-2018/notebook}{\faGithubAlt~Jupyter notebook}
  \end{repobox}
    \hypersetup{urlcolor=blue}
}
